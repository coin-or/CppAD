# ifndef CPPAD_LOCAL_OP_CLASS_ATANH_V_HPP
# define CPPAD_LOCAL_OP_CLASS_ATANH_V_HPP
...
template <class Base> class atanh_v_t : public op_class::var_unary_op_t<Base>
{
public:
   //
   // op2enum
   ...
   //
   // get_instance
   static atanh_v_t* get_instance(void)
   {  CPPAD_ASSERT_FIRST_CALL_NOT_PARALLEL;
      static atanh_v_t instance;
