# ifndef CPPAD_LOCAL_OP_CLASS_ZMUL_PV_HPP
# define CPPAD_LOCAL_OP_CLASS_ZMUL_PV_HPP
...
template <class Base> class zmul_pv_t : public var_binary_op_t<Base>
{
public:
   //
   // op2enum
   ...
   //
   // get_instance
   static zmul_pv_t* get_instance(void)
   {  CPPAD_ASSERT_FIRST_CALL_NOT_PARALLEL;
      static zmul_pv_t instance;
