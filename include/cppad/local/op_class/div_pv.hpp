# ifndef CPPAD_LOCAL_OP_CLASS_DIV_PV_HPP
# define CPPAD_LOCAL_OP_CLASS_DIV_PV_HPP
...
template <class Base> class div_pv_t : public var_binary_op_t<Base>
{
public:
   //
   // op2enum
   ...
   //
   // get_instance
   static div_pv_t* get_instance(void)
   {  CPPAD_ASSERT_FIRST_CALL_NOT_PARALLEL;
      static div_pv_t instance;
