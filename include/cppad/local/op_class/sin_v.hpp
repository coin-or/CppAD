# ifndef CPPAD_LOCAL_OP_CLASS_SIN_V_HPP
# define CPPAD_LOCAL_OP_CLASS_SIN_V_HPP
...
template <class Base> class sin_v_t : public op_class::var_unary_op_t<Base>
{
public:
   //
   // get_instance
   static sin_v_t* get_instance(void)
   {  CPPAD_ASSERT_FIRST_CALL_NOT_PARALLEL;
      static sin_v_t instance;
      return &instance;
   }
   //
   // n_res
