# ifndef CPPAD_LOCAL_OP_CLASS_MUL_VV_HPP
# define CPPAD_LOCAL_OP_CLASS_MUL_VV_HPP
...
template <class Base> class mul_vv_t : public var_binary_op_t<Base>
{
public:
   //
   // op2enum
