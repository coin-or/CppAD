# ifndef  CPPAD_LOCAL_VAL_GRAPH_ADD_OP_HPP
# define  CPPAD_LOCAL_VAL_GRAPH_ADD_OP_HPP
...
op_enum
*******
This override of :ref:`val_base_op@op_enum` returns ``add_op_enum`` .
...
Example
*******
The file :ref:`add_xam.cpp <val_add_op_xam.cpp-name>`
