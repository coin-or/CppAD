...
# endif
      ...
      {
         case AbsOp:
         op_class::abs_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case AcosOp:
         op_class::acos_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case AcoshOp:
         op_class::acosh_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case AddpvOp:
         op_class::add_pv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case AddvvOp:
         op_class::add_vv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case AsinOp:
         op_class::asin_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case AsinhOp:
         op_class::asinh_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case AtanOp:
         op_class::atan_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case AtanhOp:
         op_class::atanh_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case CosOp:
         op_class::cos_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case CoshOp:
         op_class::cosh_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case DivpvOp:
         op_class::div_pv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case DivvpOp:
         op_class::div_vp_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case DivvvOp:
         op_class::div_vv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case ErfOp:
         op_class::erf_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case ErfcOp:
         op_class::erfc_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case ExpOp:
         op_class::exp_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case Expm1Op:
         op_class::expm1_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case Log1pOp:
         op_class::log1p_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case LogOp:
         op_class::log_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case MulpvOp:
         op_class::mul_pv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case MulvvOp:
         op_class::mul_vv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case NegOp:
         op_class::neg_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case PowpvOp:
         op_class::pow_pv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case PowvpOp:
         op_class::pow_vp_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case PowvvOp:
         op_class::pow_vv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case SignOp:
         op_class::sign_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case SinOp:
         op_class::sin_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case SinhOp:
         op_class::sinh_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case SqrtOp:
         op_class::sqrt_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case SubpvOp:
         op_class::sub_pv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case SubvpOp:
         op_class::sub_vp_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case SubvvOp:
         op_class::sub_vv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case TanOp:
         op_class::tan_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case TanhOp:
         op_class::tanh_v_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case ZmulpvOp:
         op_class::zmul_pv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case ZmulvpOp:
         op_class::zmul_vp_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;

         case ZmulvvOp:
         op_class::zmul_vv_t<Base>::forward(
            p, q, i_var, arg, parameter, J, taylor
         );
         break;
