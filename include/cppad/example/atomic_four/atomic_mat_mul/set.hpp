# ifndef CPPAD_EXAMPLE_ATOMIC_FOUR_ATOMIC_MAT_MUL_SET_HPP
# define CPPAD_EXAMPLE_ATOMIC_FOUR_ATOMIC_MAT_MUL_SET_HPP
/* --------------------------------------------------------------------------
...
*/
// BEGIN C++
# include <cppad/example/atomic_four/atomic_mat_mul_hpp>
