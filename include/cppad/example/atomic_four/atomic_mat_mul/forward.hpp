# ifndef CPPAD_EXAMPLE_ATOMIC_FOUR_ATOMIC_MAT_MUL_FORWARD_HPP
# define CPPAD_EXAMPLE_ATOMIC_FOUR_ATOMIC_MAT_MUL_FORWARD_HPP
/* --------------------------------------------------------------------------
...
---------------------------------------------------------------------------- */
/*
$begin atomic_mat_mul_forward.hpp$$
$spell
    Jacobian
    jac
$$
