...
'cmake  Using CMake to Configure CppAD  ',' makefile install prefix postfix include directories lib datadir documentation package compile flags profile maximum number threads sparsity internal structure vector sets memory usage tape implicit explicit the program build directory command simple options minsys2 visual studio autotools check cmake_verbose_makefile generator cppad_prefix cppad_postfix cmake_install_includedirs cmake_install_libdirs cmake_install_datadir cmake_install_docdir package_prefix cppad_cxx_flags c++11 debug release cppad_profile_flag eigen fadbad cppad_testvector cppad_max_num_threads cppad_tape_id_type cstdint cppad_tape_addr_type cppad_debug_which cppad_deprecated ',
...
'atomic_forward  Atomic Forward Mode  ',' callback virtual syntax base ad<base> purpose implementation q vx vy tx atx ty aty ok discussion examples ',
...
'VecAD  AD Vectors that Record Index Operations  ',' tape reference vecad<base> syntax purpose alternatives vecad<base>::reference exceptions constructor size size_t indexing dynamic parameters example speed memory ',
...
'FunConstruct  Construct an ADFun Object and Stop Recording  ',' tape syntax purpose vectorad default constructor sequence copy assignment operator move semantics taylor coefficients sparsity patterns parallel mode example ',
...
'new_dynamic  Change the Dynamic Parameters  ',' syntax purpose f vectorbase taylor coefficients example ',
...
'preprocessor  CppAD API Preprocessor Symbols  ',' cppad_ null pointer rule nominmax documented here cppad_debug_and_release cppad_null cppad_package_string cppad_use_cplusplus_2011 elsewhere deprecated ',
...
'elapsed_seconds  Returns Elapsed Number of Seconds  ',' time syntax purpose example ',
...
'get_started.cpp  Getting Started Using CppAD to Compute Derivatives  ',' simple example purpose function value include file poly namespace preprocessor symbols program output running exercises ',
...
'wish_list  The CppAD Wish List  ',' see also purpose checkpoint tapeless re-taping testing subgraph forward mode sparsity constant new atomic dynamic parameters patterns dependency element-wise operations abs-normal windows install check_finite test_boolofvoid example optimization special operators compilation speed base requirements adolc recomputation iterator interface convert tabs spaces tracing atan2 ',
'whats_new  Changes and Additions to CppAD  ',' introduction this year previous years ',
'whats_new_18  Changes and Additions to CppAD During 2018  ',' 11-13 11-11 11-06 11-04 11-01 10-31 10-29 10-25 10-24 10-19 10-18 09-25 09-23 09-22 09-19 09-17 09-16 09-15 08-27 08-19 08-18 08-17 08-16 08-14 08-13 08-12 08-10 08-08 08-05 08-04 07-30 07-27 07-23 07-18 07-02 06-27 06-22 06-20 06-19 06-13 06-12 06-04 05-29 05-28 05-26 05-20 05-17 05-04 05-03 04-29 04-13 03-20 03-19 03-04 03-02 02-27 02-26 02-23 02-20 ',
