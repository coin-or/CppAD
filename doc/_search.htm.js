...
{ tag: 'cpp_ad_graph', title:'C++ Representation of an AD Graph', other:' see also function node indices x function_name discrete_name_vec atomic_name_vec n_dynamic_ind n_variable_ind constant_vec operator_vec c++11 operator_arg dis_graph_op atom_graph_op sum_graph_op dependent_vec cpp_graph' },
{ tag: 'graph_op_enum', title:'C++ AD Graph Operator Enum Type', other:' unary require c++11 binary conditional expression other comparisons summation discrete function atomic missing operators values examples' },
...
{ tag: 'cpp_graph_vector', title:'C++ AD Graph Vector Values', other:' syntax size get push back index push_back graph_obj discrete_name atomic_name constant op_enum argument node_index' },
...
{ tag: 'rosen_34.cpp', title:'rosen_34: Example and Test', other:'' },
