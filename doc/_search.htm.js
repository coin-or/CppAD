...
{ tag: 'atomic_four', title:'Defining Atomic Functions: Fourth Generation', other:' syntax define class constructor call callbacks see also purpose speed reduce memory virtual' },
{ tag: 'atomic_four_example', title:'Example Defining Atomic Functions: Fourth Generation', other:'' },
{ tag: 'atomic_four_ctor', title:'Atomic Function Constructor', other:' syntax prototype atomic_user ctor_arg_list afun implementation restrictions base name example define' },
{ tag: 'atomic_four_call', title:'Calling an Atomic Function', other:' syntax prototype purpose base advector afun ay call_id restriction' },
...
{ tag: 'atomic_four_forward', title:'Atomic Function Forward Mode', other:' syntax base ad<base> prototype vector usage implementation call_id select_y order_low order_up q taylor_x parameters ataylor_x taylor_y ataylor_y ok discussion examples' },
...
{ tag: 'atomic_four_reverse', title:'Atomic Function Reverse Mode', other:' syntax base ad<base> prototype vector usage implementation call_id select_x order_up q taylor_x parameters ataylor_x taylor_y ataylor_y h partial_y apartial_y partial_x azmul apartial_x ok examples' },
{ tag: 'atomic_four_jac_sparsity', title:'Atomic Function Jacobian Sparsity Patterns', other:' syntax prototype implementation base vector call_id dependency select_x select_y pattern_out ok examples' },
{ tag: 'atomic_four_hes_sparsity', title:'Atomic Function Hessian Sparsity Patterns', other:' syntax prototype implementation base vector call_id select_x select_y pattern_out ok examples' },
{ tag: 'atomic_four_rev_depend', title:'Atomic Function Reverse Dependency', other:' syntax prototype analysis implementation base vector call_id depend_x optimize depend_y ok example' },
...
{ tag: 'atomic_vector', title:'Atomic Vector Element-wise Operators: Example and Test', other:' syntax purpose operations atomic_four base2ad ad<double>' },
{ tag: 'atomic_vector_implement', title:'Implementing Atomic Vector Operations', other:'' },
{ tag: 'atomic_vector.hpp', title:'Atomic Vector Class: Example Implementation', other:'' },
{ tag: 'atomic_vector_forward_op.hpp', title:'Atomic Vector Forward Mode: Example Implementation', other:' purpose source' },
{ tag: 'atomic_vector_reverse_op.hpp', title:'Atomic Vector Forward Mode: Example Implementation', other:' purpose source' },
{ tag: 'atomic_vector_jac_sparsity.hpp', title:'Atomic Vector Jacobian Sparsity Pattern: Example Implementation', other:' purpose source' },
{ tag: 'atomic_vector_hes_sparsity.hpp', title:'Atomic Vector Hessian Sparsity Pattern: Example Implementation', other:' purpose source' },
{ tag: 'atomic_vector_for_type.hpp', title:'Atomic Vector Forward Type Calculation: Example Implementation', other:' purpose source' },
{ tag: 'atomic_vector_rev_depend.hpp', title:'Atomic Vector Forward Type Calculation: Example Implementation', other:' purpose source' },
{ tag: 'atomic_vector_add_op.hpp', title:'Atomic Vector Add Operator: Example Implementation', other:' forward mode reverse source' },
{ tag: 'atomic_vector_sub_op.hpp', title:'Atomic Vector Subtract Operator: Example Implementation', other:' forward mode reverse source' },
{ tag: 'atomic_vector_mul_op.hpp', title:'Atomic Vector Multiply Operator: Example Implementation', other:' forward mode reverse source' },
{ tag: 'atomic_vector_div_op.hpp', title:'Atomic Vector Divide Operator: Example Implementation', other:' forward mode reverse source' },
{ tag: 'atomic_vector_neg_op.hpp', title:'Atomic Vector Negative Operator: Example Implementation', other:' source' },
...
{ tag: 'atomic_mat_mul', title:'Atomic Matrix Multiply Class: Example Implementation', other:' under construction syntax purpose n_left n_middle n_right call_id theory forward argument scalar valued function reverse' },
{ tag: 'atomic_mat_mul_implement', title:'Implementing Atomic Matrix Multiply', other:'' },
{ tag: 'atomic_mat_mul.hpp', title:'Atomic Matrix Multiply Class: Example Implementation', other:'' },
{ tag: 'atomic_mat_mul_set.hpp', title:'atomic_mat_mul Set Routine: Example Implementation', other:' syntax prototype purpose n_left n_middle n_right call_id source' },
{ tag: 'atomic_mat_mul_get.hpp', title:'atomic_mat_mul Get Routine: Example Implementation', other:' syntax prototype purpose call_id n_left n_middle n_right source' },
{ tag: 'atomic_mat_mul_base_mat_mul.hpp', title:'Atomic Multiply Base Matrices: Example Implementation', other:' source' },
{ tag: 'atomic_mat_mul_for_type.hpp', title:'Atomic Matrix Multiply Forward Type Calculation: Example Implementation', other:' purpose source' },
{ tag: 'atomic_mat_mul_forward.hpp', title:'Atomic Matrix Multiply Forward Mode: Example Implementation', other:' purpose source' },
{ tag: 'atomic_mat_mul_reverse.hpp', title:'Atomic Matrix Multiply Reverse Mode: Example Implementation', other:' purpose theory source' },
{ tag: 'atomic_mat_mul_jac_sparsity.hpp', title:'Atomic Matrix Multiply Jacobian Sparsity Pattern: Example Implementation', other:' purpose source' },
{ tag: 'atomic_mat_mul_hes_sparsity.hpp', title:'Atomic Matrix Multiply Jacobian Sparsity Pattern: Example Implementation', other:' purpose source' },
{ tag: 'atomic_mat_mul_rev_depend.hpp', title:'Atomic Matrix Multiply Reverse Dependency Analysis: Example Implementation', other:' purpose source' },
...
{ tag: 'sparse_rc', title:'Row and Column Index Sparsity Patterns', other:' syntax sizevector empty other assignment constructor move semantics swap nr nc nnz resize set push_back row_major col_major example os' },
...
{ tag: 'wish_list', title:'The CppAD Wish List', other:' see also purpose dynamic parameters comparison operators vecad vectors graph reverse mode atomic examples abs-normal functions return cancellation cppad_lib requirement inline compilation speed checkpoint tapeless re-taping testing subgraph forward sparsity check_finite test_boolofvoid optimization special base requirements adolc recomputation iterator interface tracing atan2' },
{ tag: 'whats_new', title:'Changes and Additions to CppAD', other:' introduction this year previous years' },
{ tag: 'whats_new_22', title:'Changes and Additions to CppAD During 2022', other:' 02-13 02-12 02-11 02-01 01-27 01-25 01-23 01-19 01-15 01-06 01-04 01-01' },
