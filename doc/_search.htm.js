...
{ tag: 'atomic_four_for_type', title:'Atomic Function Forward Type Calculation', other:' syntax prototype dependency analysis usage implementation base vector call_id ad_type type_x type_y ok example' },
{ tag: 'atomic_four_forward', title:'Atomic Function Forward Mode', other:' base vector syntax ad<base> prototype usage implementation call_id select_y order_low order_up q taylor_x parameters ataylor_x taylor_y ataylor_y ok discussion examples' },
...
{ tag: 'atomic_four_reverse', title:'Atomic Function Reverse Mode', other:' base vector syntax ad<base> prototype usage implementation call_id select_x order_up q taylor_x parameters ataylor_x taylor_y ataylor_y h partial_y apartial_y partial_x azmul apartial_x ok examples' },
...
{ tag: 'atomic_vector_add.cpp', title:'Atomic Vector Addition Example', other:' f(u w) g(u source' },
{ tag: 'atomic_vector_div.cpp', title:'Atomic Vector Division Example', other:' f(u w) g(u v) source' },
{ tag: 'atomic_vector_hes_sparsity.cpp', title:'Atomic Vector Sparsity Patterns Example', other:' f(u v) source' },
{ tag: 'atomic_vector_jac_sparsity.cpp', title:'Atomic Vector Sparsity Patterns Example', other:' f(u v) source' },
{ tag: 'atomic_vector_mul.cpp', title:'Atomic Vector Multiplication Example', other:' f(u w) g(u source' },
{ tag: 'atomic_vector_neg.cpp', title:'Atomic Vector Negation Example', other:' f(u w) g(u source' },
{ tag: 'atomic_vector_rev_depend.cpp', title:'Example Optimizing Atomic Vector Usage', other:' f(u v) source' },
{ tag: 'atomic_vector_sub.cpp', title:'Atomic Vector Subtraction Example', other:' f(u w) g(u source' },
...
{ tag: 'whats_new_22', title:'Changes and Additions to CppAD During 2022', other:' 02-12 02-11 02-01 01-27 01-25 01-23 01-19 01-15 01-06 01-04 01-01' },
