...
'checkpoint  Checkpointing Functions  ',' syntax see also purpose reduce memory faster recording repeating forward restriction multiple level ad method constructor base advector name ay sparsity optimize size_var option algo atom_fun parallel mode clear example ',
'checkpoint_get_started.cpp  Simple Checkpointing: Example and Test  ',' purpose ',
'checkpoint_mul_level.cpp  Atomic Operations and Multiple-Levels of AD: Example and Test  ',' discussion ',
...
'atomic_three  Defining Atomic Functions: Third Generation  ',' syntax see also purpose speed reduce memory virtual ad_type ',
'atomic_three_example  Example Defining Atomic Functions: Third Generation  ',' ',
'atomic_three_ctor  Atomic Function Constructor  ',' syntax atomic_user ctor_arg_list afun implementation restrictions base name example define ',
'atomic_three_afun  Using AD Version of an Atomic Function  ',' syntax purpose advector ay ',
'atomic_three_type  Atomic Function Type Calculation  ',' syntax prototype usage implementation parameter_x type_x type_y ok examples ',
'atomic_three_forward  Atomic Function Forward Mode  ',' base syntax prototype ad<base> implementation need_y dynamic parameters variables all order_low order_up q type_x taylor_x ataylor_x taylor_y ataylor_y ok discussion examples ',
'atomic_three_forward.cpp  Atomic Functions and Forward Mode: Example and Test  ',' purpose jacobian hessian start class definition constructor type use ',
'atomic_three_dynamic.cpp  Atomic Functions with Dynamic Parameters: Example and Test  ',' purpose start class definition constructor type forward end use recording return result ',
'atomic_three_reverse  Atomic Function Reverse Mode  ',' base syntax prototype ad<base> implementation order_up taylor_x ataylor_x taylor_y ataylor_y g partial_y apartial_y partial_x short circuit operations apartial_x ok examples ',
'atomic_three_reverse.cpp  Atomic Functions and Reverse Mode: Example and Test  ',' purpose jacobian hessian start class definition constructor type forward use ',
'atomic_three_jac_sparsity  Atomic Function Jacobian Sparsity Patterns  ',' syntax prototype implementation dependency parameter_x type_x select_x select_y pattern_out ok examples ',
'atomic_three_jac_sparsity.cpp  Atomic Function Jacobian Sparsity: Example and Test  ',' purpose start class definition constructor type forward use with u_1 both variable parameter ',
'atomic_three_hes_sparsity  Atomic Function Hessian Sparsity Patterns  ',' syntax prototype implementation parameter_x type_x select_x select_y pattern_out ok examples ',
'atomic_three_hes_sparsity.cpp  Atomic Forward Hessian Sparsity: Example and Test  ',' purpose function jacobian hessians start class definition constructor type jac_sparsity use with u_1 both variable parameter ',
'atomic_three_get_started.cpp  Getting Started with Atomic Functions: Example and Test  ',' purpose class definition constructor type forward end use recording return result ',
'atomic_three_norm_sq.cpp  Atomic Euclidean Norm Squared: Example and Test  ',' function start class definition constructor type forward reverse jac_sparsity hes_sparsity end use recording rev_jac_sparsity for_hes_sparsity ',
'atomic_three_tangent.cpp  Tan and Tanh as User Atomic Operations: Example and Test  ',' discussion start class definition constructor type forward reverse jac_sparsity hes_sparsity end function recording for_jac_sparsity rev_sparse_hes large values ',
'atomic_three_base2ad.cpp  base2ad with Atomic Operations: Example and Test  ',' source code ',
'atomic_three_reciprocal.cpp  Reciprocal as an Atomic Operation: Example and Test  ',' function start class definition constructor type forward reverse jac_sparsity hes_sparsity end use recording for_jac_sparsity rev_sparse_jac rev_sparse_hes for_sparse_hes ',
...
'atomic_mat_mul.hpp  Matrix Multiply as an Atomic Operation  ',' see also purpose dimensions left right result start class definition constructor operand element index forward reverse type jac_sparsity hes_sparsity end ',
...
'whats_new_19  Changes and Additions to CppAD During 2019  ',' 01-06 01-05 ',
