...
'cmake  Using CMake to Configure CppAD  ',' the program build directory command simple options minsys2 visual studio autotools check cmake_verbose_makefile generator cppad_prefix cppad_postfix cmake_install_includedirs cmake_install_libdirs cmake_install_datadir cmake_install_docdir package_prefix cppad_cxx_flags c++11 debug release cppad_profile_flag eigen fadbad cppad_testvector cppad_max_num_threads cppad_tape_id_type cstdint cppad_tape_addr_type cppad_debug_which cppad_deprecated ',
...
'atomic_base  User Defined Atomic AD Functions  ',' syntax see also purpose speed reduce memory virtual examples ',
'atomic_example  Example User Defined Atomic Functions  ',' getting started scalar vector range hessian sparsity patterns general case ',
...
'atomic_forward  Atomic Forward Mode  ',' syntax base ad<base> purpose implementation q vx vy tx atx ty aty ok discussion examples ',
'atomic_forward.cpp  Atomic Forward: Example and Test  ',' purpose function start class definition constructor use ',
'atomic_reverse  Atomic Reverse Mode  ',' syntax base ad<base> purpose implementation q tx atx ty aty f g h py apy px apx ok examples ',
...
'atomic_norm_sq.cpp  Atomic Euclidean Norm Squared: Example and Test  ',' theory sparsity start class definition constructor forward reverse for_sparse_jac rev_sparse_jac rev_sparse_hes end use function recording ',
'atomic_reciprocal.cpp  Reciprocal as an Atomic Operation: Example and Test  ',' theory sparsity start class definition constructor forward reverse for_sparse_jac rev_sparse_jac rev_sparse_hes end use function recording ',
...
'atomic_base2ad.cpp  base2ad with Atomic Operations: Example and Test  ',' source code ',
...
'wish_list  The CppAD Wish List  ',' see also purpose inline checkpoint constructor tapeless re-taping testing subgraph forward mode sparsity constant new atomic dynamic parameters patterns dependency element-wise operations abs-normal windows install check_finite test_boolofvoid example optimization special operators compilation speed base requirements adolc recomputation iterator interface convert tabs spaces tracing atan2 ',
'whats_new  Changes and Additions to CppAD  ',' introduction this year previous years ',
'whats_new_18  Changes and Additions to CppAD During 2018  ',' 12-12 11-13 11-11 11-06 11-04 11-01 10-31 10-29 10-25 10-24 10-19 10-18 09-25 09-23 09-22 09-19 09-17 09-16 09-15 08-27 08-19 08-18 08-17 08-16 08-14 08-13 08-12 08-10 08-08 08-05 08-04 07-30 07-27 07-23 07-18 07-02 06-27 06-22 06-20 06-19 06-13 06-12 06-04 05-29 05-28 05-26 05-20 05-17 05-04 05-03 04-29 04-13 03-20 03-19 03-04 03-02 02-27 02-26 02-23 02-20 ',
...
'TrackNewDel  Routines That Track Use of New and Delete  ',' deprecated 2007-07-23 syntax purpose include file line oldptr newlen head newptr ncopy tracknewvec macro previously trackdelvec trackextend trackcount multi-threading example ',
...
'omp_alloc.cpp  OpenMP Memory Allocator: Example and Test  ',' deprecated 2011-08-31 ',
...
'ipopt_nlp_ode_simple  ODE Fitting Using Simple Representation  ',' purpose argument vector objective function initial condition constraint trapezoidal approximation source ',
...
'ipopt_nlp_ode_problem.hpp  ODE Inverse Problem Definitions: Source Code  ',' ',
'ipopt_nlp_ode_simple.hpp  ODE Fitting Using Simple Representation  ',' ',
'ipopt_nlp_ode_fast.hpp  ODE Fitting Using Fast Representation  ',' ',
...
'old_atomic  User Defined Atomic AD Functions  ',' deprecated 2013-05-27 syntax callback routines free static memory purpose partial implementation cppad_user_atomic tvector base ok id tx ty forward reverse afun ay parallel mode usage vx vy py px for_jac_sparse q rev_jac_sparse rev_hes_sparse clear restriction example simple tangent matrix multiplication ',
'old_reciprocal.cpp  Old Atomic Operation Reciprocal: Example and Test  ',' deprecated 2013-05-27 theory ',
'old_usead_1.cpp  Using AD to Compute Atomic Function Derivatives  ',' deprecated 2013-05-27 purpose simple case ',
'old_usead_2.cpp  Using AD to Compute Atomic Function Derivatives  ',' deprecated 2013-05-27 purpose ',
...
'old_mat_mul.hpp  Define Matrix Multiply as a User Atomic Operation  ',' syntax example begin source extra call information indexing one reverse partials order set union cppad callback functions declare ',
