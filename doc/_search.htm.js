...
{ tag: 'VecAD', title:'AD Vectors that Record Index Operations', other:' syntax purpose alternatives vecad<base>::reference exceptions constructor size indexing result right left dynamic parameters example speed memory' },
...
{ tag: 'cpp_ad_graph', title:'C++ Representation of an AD Graph', other:' see also function node indices x function_name discrete_name_vec atomic_name_vec print_text_vec n_dynamic_ind n_variable_ind constant_vec operator_vec c++11 operator_arg dis_graph_op atom_graph_op sum_graph_op dependent_vec cpp_graph' },
{ tag: 'graph_op_enum', title:'C++ AD Graph Operator Enum Type', other:' unary require c++11 binary conditional expression other comparisons summation discrete function atomic print missing operators values examples' },
...
{ tag: 'whats_new_20', title:'Changes and Additions to CppAD During 2020', other:' 01-04' },
