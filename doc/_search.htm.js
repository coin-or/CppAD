...
{ tag: 'atomic_four_lin_ode', title:'Atomic First Order Linear ODE Method: Example Implementation', other:' under construction syntax purpose call_id pattern nnz row col transpose a(x) b(x) theory forward reverse rosen34 simpon\'s rule' },
...
{ tag: 'atomic_four_lin_ode_set.hpp', title:'atomic_lin_ode Set Routine: Example Implementation', other:' syntax prototype purpose pattern transpose source' },
{ tag: 'atomic_four_lin_ode_get.hpp', title:'atomic_lin_ode Get Routine: Example Implementation', other:' syntax prototype purpose call_id pattern transpose source' },
{ tag: 'atomic_four_lin_ode_base_lin_ode.hpp', title:'Atomic Multiply Base Matrices: Example Implementation', other:' rosen34 source' },
{ tag: 'atomic_four_lin_ode_for_type.hpp', title:'Atomic Linear ODE Forward Type Calculation: Example Implementation', other:' purpose source' },
...
{ tag: 'atomic_four_lin_ode_reverse.hpp', title:'Atomic Linear ODE Reverse Mode: Example Implementation', other:' under construction purpose theory simpon\'s rule source' },
{ tag: 'atomic_four_lin_ode_jac_sparsity.hpp', title:'Atomic Linear ODE Jacobian Sparsity Pattern: Example Implementation', other:' purpose source' },
...
{ tag: 'atomic_four_lin_ode_reverse.cpp', title:'Atomic Linear ODE Reverse Mode: Example and Test', other:' under construction purpose f(u) solution g(u) source' },
{ tag: 'atomic_four_lin_ode_sparsity.cpp', title:'Atomic Linear ODE Sparsity Calculations: Example and Test', other:' under construction purpose f(u) solution source' },
...
{ tag: 'sparse_rc', title:'Row and Column Index Sparsity Patterns', other:' syntax include constructor assignment equality setting properties output sizevector empty other move semantics swap nr nnz resize push_back row_major col_major example os' },
...
{ tag: 'whats_new_22', title:'Changes and Additions to CppAD During 2022', other:' 04-19 04-15 03-29 03-26 03-25 03-24 03-23 02-21 02-19 02-18 02-17 02-16 02-13 02-12 02-11 02-01 01-27 01-25 01-23 01-19 01-15 01-06 01-04 01-01' },
