...
{ tag: 'atomic_four_lin_ode', title:'Atomic First Order Linear ODE Method: Example Implementation', other:' under construction syntax z(t x) y(x) call_id pattern nnz row col transpose a(x) b(x) approximations rosen34 simpon\'s rule' },
...
{ tag: 'atomic_four_lin_ode_for_type.hpp', title:'Atomic Linear ODE Forward Type Calculation: Example Implementation', other:' purpose representation notation theory source' },
...
{ tag: 'atomic_four_lin_ode_jac_sparsity.hpp', title:'Atomic Linear ODE Jacobian Sparsity Pattern: Example Implementation', other:' purpose representation notation s[ g(x) ] j_i a(x) p_i theory source' },
...
{ tag: 'whats_new_22', title:'Changes and Additions to CppAD During 2022', other:' 05-11 05-10 05-09 05-07 05-06 04-21 04-20 04-19 04-15 03-29 03-26 03-25 03-24 03-23 02-21 02-19 02-18 02-17 02-16 02-13 02-12 02-11 02-01 01-27 01-25 01-23 01-19 01-15 01-06 01-04 01-01' },
