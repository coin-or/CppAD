...
'acos  Inverse Cosine Function: acos  ',' syntax atomic derivative example ',
...
'atomic_three_forward  Atomic Function Forward Mode  ',' base syntax prototype ad<base> implementation parameter_x aparameter_x type_x need_y constant parameters dynamic variables all order_low order_up q taylor_x ataylor_x taylor_y ataylor_y ok discussion examples ',
...
'chkpoint_two  Checkpoint Functions: Second Generation  ',' syntax constructor use new_dynamic reduce memory faster recording repeating forward operation sequence atomic_three base ',
...
'json_asin_op.cpp  Json asin Operator: Example and Test  ',' source code ',
'json_atan_op.cpp  Json atan Operator: Example and Test  ',' source code ',
'json_cosh_op.cpp  Json cosh Operator: Example and Test  ',' source code ',
'json_cos_op.cpp  Json cos Operator: Example and Test  ',' source code ',
'json_exp_op.cpp  Json exp Operator: Example and Test  ',' source code ',
'json_log_op.cpp  Json log Operator: Example and Test  ',' source code ',
'json_sign_op.cpp  Json sign Operator: Example and Test  ',' source code ',
'json_sinh_op.cpp  Json sinh Operator: Example and Test  ',' source code ',
'json_sin_op.cpp  Json sin Operator: Example and Test  ',' source code ',
'json_sqrt_op.cpp  Json sqrt Operator: Example and Test  ',' source code ',
'json_tanh_op.cpp  Json tanh Operator: Example and Test  ',' source code ',
'json_tan_op.cpp  Json tan Operator: Example and Test  ',' source code ',
'json_acosh_op.cpp  Json acosh Operator: Example and Test  ',' source code ',
'json_asinh_op.cpp  Json asinh Operator: Example and Test  ',' source code ',
'json_atanh_op.cpp  Json atanh Operator: Example and Test  ',' source code ',
'json_erf_op.cpp  Json erf Operator: Example and Test  ',' source code ',
'json_erfc_op.cpp  Json erfc Operator: Example and Test  ',' source code ',
'json_expm1_op.cpp  Json expm1 Operator: Example and Test  ',' source code ',
'json_log1p_op.cpp  Json log1p Operator: Example and Test  ',' source code ',
'json_add_op.cpp  Json add Operator: Example and Test  ',' source code ',
'json_atom_op.cpp  Json Atomic Function Operator: Example and Test  ',' source code ',
'json_div_op.cpp  Json div Operator: Example and Test  ',' source code ',
'json_mul_op.cpp  Json mul Operator: Example and Test  ',' source code ',
'json_sub_op.cpp  Json sub Operator: Example and Test  ',' source code ',
'json_sum_op.cpp  Json sum Operator: Example and Test  ',' source code ',
...
'CppAD_vector  The CppAD::vector Template Class  ',' syntax description include deprecated 2019-08-19 capacity swap assignment check size return reference move semantics element access error checking push_back push_vector output resize clear data iterators const_iterator begin end vectorbool memory bit_per_unit type parallel mode example exercise ',
