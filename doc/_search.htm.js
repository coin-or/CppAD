...
{ tag: 'json_ad_graph', title:'Json Format for A Graph Representing an ADFun object', other:' under construction node indices x o_i token white space non-negative integer floating point number string single character op_define_vec op_code n_arg n_result op_usage not strings first_arg ... last_arg dynamic_ind_vec n_dynamic_ind independent_vec n_independent constant_vec n_constant op_usage_vec n_usage n_dependent function_name' },
{ tag: 'json_op_define', title:'Json Operator Definitions', other:' notation op_code arguments unary operators example binary add div mul sub sum conditional expressions cexp_eq cexp_le cexp_lt other comparisons compare comp_eq comp_le comp_lt comp_ne atomic functions name n_result n_arg first_arg ... last_arg' },
{ tag: 'json_unary_op.cpp', title:'Json Unary Operator: Example and Test', other:' source code' },
...
{ tag: 'from_json', title:'ADFun Object Corresponding to a Json AD Graph', other:' under construction syntax prototype base recbase example' },
{ tag: 'from_json.cpp', title:'Convert Jason Graph to an ADFun Object: Example and Test', other:' source code' },
{ tag: 'to_json', title:'Create a Json AD Graph Corresponding to an ADFun Object', other:' under construction syntax prototype base recbase example' },
{ tag: 'to_json.cpp', title:'Convert an ADFun Object to a Json AD Graph: Example and Test', other:' source code' },
{ tag: 'json_sparse.cpp', title:'Using Json to Represent a Sparse Matrix: Example and Test', other:' discussion source code' },
