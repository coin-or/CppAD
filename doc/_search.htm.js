...
{ tag: 'get_optional.sh', title:'Download and Install The CppAD Optional Packages', other:' syntax purpose distribution directory prefix output' },
...
{ tag: 'get_cppadcg.sh', title:'Download and Install CppADCodeGen in Build Directory', other:' syntax purpose requirements distribution source prefix git hash configuration' },
...
{ tag: 'adolc_prefix', title:'Including the Adolc Examples and Tests', other:' home page purpose speed unix cygwin get_adolc' },
{ tag: 'colpack_prefix', title:'Including the Colpack Sparsity Calculations', other:' home page purpose cppad_lib example get_colpack' },
...
{ tag: 'eigen_prefix', title:'Including the Eigen Examples and Tests', other:' home page purpose vector get_eigen' },
{ tag: 'fadbad_prefix', title:'Including the Fadbad Speed Tests', other:' home page purpose get_fadbad' },
{ tag: 'cppadcg_prefix', title:'Including the Cppadcg Speed Tests', other:' home page purpose get_cppadcg' },
{ tag: 'ipopt_prefix', title:'Including the cppad_ipopt Library and Tests', other:' purpose examples get_ipopt' },
{ tag: 'sacado_prefix', title:'Including the Sacado Speed Tests', other:' home page purpose get_sacado' },
...
{ tag: 'VecAD', title:'AD Vectors that Record Index Operations', other:' syntax purpose alternatives efficiency vecad<base>::reference exceptions constructor size indexing result right left example speed memory' },
...
{ tag: 'cppadcg_det_minor.cpp', title:'Cppadcg Speed: Gradient of Determinant by Minor Expansion', other:' specifications implementation' },
{ tag: 'cppadcg_det_minor_grad.c', title:'Cppadcg Speed: Gradient of Determinant by Minor Expansion', other:' syntax prototype purpose optimize size flag implementation' },
{ tag: 'cppadcg_det_minor_cg.cpp', title:'Cppadcg Speed: Source Generation: Gradient of Determinant by Minor', other:' syntax purpose n_size size_vec det_minor_grad.c implementation' },
...
{ tag: 'cppadcg_sparse_jacobian.cpp', title:'Cppadcg Speed: sparse_jacobian', other:' specifications' },
{ tag: 'cppadcg_sparse_jacobian.c', title:'Cppadcg Speed: Sparse Jacobian', other:' syntax prototype purpose subgraph optimize seed size nnz flag' },
{ tag: 'cppadcg_sparse_jacobian_cg.cpp', title:'Cppadcg Speed: Source Generation: Sparse Jacobian', other:' syntax purpose subgraph optimize seed size_vec sparse_jacobian.c choose_row_col implementation' },
...
{ tag: 'whats_new_20', title:'Changes and Additions to CppAD During 2020', other:' 01-29 01-24 01-22 01-18 01-17 01-12 01-06 01-04' },
