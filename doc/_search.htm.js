...
{ tag: 'sparse_rc', title:'Row and Column Index Sparsity Patterns', other:' syntax sizevector empty other assignment swap nr nc nnz resize set k row_major col_major example' },
{ tag: 'sparse_rc.cpp', title:'sparse_rc: Example and Test', other:'' },
{ tag: 'sparse_rcv', title:'Sparse Matrix Row, Column, Value Representation', other:' syntax sizevector valuevector empty pattern other assignment swap nr nc nnz set k row_major col_major eigen example' },
...
{ tag: 'compiled_fun', title:'Compile and Link Source For an AD Function', other:' syntax constructor operations prototype constructors cppad::cg::cg<double> speed fun_name other_fun file_name cg_fun eval_jac swap jrcv examples' },
{ tag: 'compiled_fun_function.cpp', title:'Compiled AD Function Value: Example and Test', other:'' },
{ tag: 'compiled_fun_file.cpp', title:'Compiled AD File Store and Retrieve: Example and Test', other:'' },
{ tag: 'compiled_fun_jacobian.cpp', title:'Compiled AD Jacobian Values: Example and Test', other:'' },
{ tag: 'compiled_fun_jac_as_fun.cpp', title:'Compiled AD Jacobian As Function Value: Example and Test', other:'' },
{ tag: 'compiled_fun_sparse_jacobian.cpp', title:'Compiled AD Jacobian Values: Example and Test', other:'' },
{ tag: 'compiled_fun_sparse_jac_as_fun.cpp', title:'Compiled AD Sparse Jacobian As Function Value: Example and Test', other:'' },
...
{ tag: 'cppadcg_sparse_jacobian.cpp', title:'Cppadcg Speed: Sparse Jacobian', other:' specifications implementation' },
...
{ tag: 'whats_new_20', title:'Changes and Additions to CppAD During 2020', other:' 12-19 12-12 12-11 12-06 12-05 12-04 12-03 12-02 12-01 11-29 10-26 10-23 10-22 10-21 10-20 10-17 09-05 06-08 06-04 05-27 05-26 05-23 05-01 03-11 02-02 02-01 01-29 01-24 01-22 01-18 01-17 01-12 01-06 01-04' },
