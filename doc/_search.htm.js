...
'atomic_three_type  Atomic Function Type Calculation  ',' syntax prototype usage implementation type_x type_y ok examples ',
...
'atomic_three_jac_sparsity  Atomic Function Jacobian Sparsity Patterns  ',' syntax prototype implementation dependency parameter_x select_x select_y pattern_out ok examples ',
...
'atomic_three_hes_sparsity  Atomic Function Hessian Sparsity Patterns  ',' syntax prototype implementation parameter_x select_x select_y pattern_out ok examples ',
...
'whats_new_19  Changes and Additions to CppAD During 2019  ',' 01-05 ',
...
'atomic_two_example  Example Defining Atomic Functions: Second Generation  ',' getting started scalar vector range hessian sparsity patterns general case ',
...
'atomic_two_mat_mul.cpp  User Atomic Matrix Multiply: Example and Test  ',' see also class definition function constructor recording forward reverse option for_sparse_jac rev_sparse_jac rev_sparse_hes ',
