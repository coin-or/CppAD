...
{ tag: 'cmake', title:'Using CMake to Configure CppAD', other:' the program build directory command simple warning options msys2 visual studio autotools check cmake_verbose_makefile cmake_build_type cmake_needs_dot_slash generator cppad_prefix cppad_postfix cmake_install_includedirs cmake_install_libdirs cppad_lib cmake_install_datadir cmake_install_docdir cmake_defined_ok include_adolc include_eigen include_ipopt include_cppadcg eigen_prefix package_prefix cppad_cxx_flags c++17 debug release clang cppad_profile_flag cppad_testvector cppad_max_num_threads cppad_tape_id_type cstdint cppad_tape_addr_type cppad_debug_which' },
...
{ tag: 'eigen', title:'Including Eigen Examples, Tests, and sparse2eigen', other:' home page include_eigen eigen_prefix vector get_eigen' },
...
{ tag: 'ad_ctor', title:'AD Constructors', other:' syntax purpose implicit explicit ay example' },
...
{ tag: 'atomic_four_example', title:'Examples Defining Atomic Functions: Fourth Generation', other:'' },
...
{ tag: 'atomic_four_lin_ode', title:'Atomic First Order Linear ODE Method: Example Implementation', other:' syntax z(t x) call_id step pattern nnz row col transpose a(x) b(x) y(x) ay vk(x) approximations rosen34 simpson\'s rule' },
...
{ tag: 'atomic_four_lin_ode_forward.hpp', title:'Atomic Linear ODE Forward Mode: Example Implementation', other:' purpose theory extend_ode source' },
{ tag: 'atomic_four_lin_ode_reverse.hpp', title:'Atomic Linear ODE Reverse Mode: Example Implementation', other:' purpose first order theory second simpson\'s rule source' },
{ tag: 'atomic_four_lin_ode_reverse_2', title:'Atomic Linear ODE Second Order Reverse', other:' x^1 partial x^0' },
...
{ tag: 'base_member', title:'Required Base Class Member Functions', other:' notation constructors default int size_t double copy unary operators assignment binary bool example' },
...
{ tag: 'to_csrc', title:'C Source Code Corresponding to an ADFun Object', other:' syntax prototype base recbase os c_type jit functions atomic callbacks call_id nu ny compare_change flag restrictions example' },
{ tag: 'example_jit', title:'JIT Creation, Compilation, and Linking of C Source Code', other:'' },
{ tag: 'jit_get_started.cpp', title:'JIT Computation of Derivatives: Example and Test', other:' purpose source' },
{ tag: 'jit_to_csrc.cpp', title:'C Source Code Corresponding to a Function: Example and Test', other:'' },
{ tag: 'jit_compile.cpp', title:'JIT Compiler Options: Example and Test', other:' source' },
{ tag: 'jit_atomic.cpp', title:'Atomic Callbacks in JIT Function: Example and Test', other:' source' },
{ tag: 'jit_dynamic.cpp', title:'JIT With Dynamic Parameters: Example and Test', other:' source' },
{ tag: 'preprocessor', title:'CppAD API Preprocessor Symbols', other:' rule nominmax windows.h documented here cppad_debug_and_release cppad_null cppad_package_string cppad_use_cplusplus_2011 cppad_use_cplusplus_2017 elsewhere deprecated' },
...
{ tag: 'utility', title:'Some General Purpose Utilities', other:' testing c++ concepts numerical routines miscellaneous error handler the cppad vector template class multi-threading memory allocation sorting indices to_string set_union sparse matrices dynamic libraries' },
...
{ tag: 'create_dll_lib', title:'Create a Dynamic Link Library', other:' syntax prototype include dll_file stringvector csrc_files options compile err_msg example' },
...
{ tag: 'link_dll_lib', title:'Link a Dynamic Link Library', other:' syntax prototype dll_linker err_msg dll_file function_name fun_ptr example' },
{ tag: 'dll_lib.cpp', title:'dll_lib: Example and Test', other:' options source' },
...
{ tag: 'cppad_eigen.hpp', title:'Enable Use of Eigen Linear Algebra Package with CppAD', other:' syntax purpose example declarations std include eigen/core numtraits scalarbinaryoptraits namespace eigen_vector cppad.hpp definitions' },
...
{ tag: 'testvector', title:'Using The CppAD Test Vector Template Class', other:' syntax choice cppad::vector cppad_cppadvector deprecated 2022-06-22 std::vector cppad_stdvector boost::numeric::ublas::vector cppad_boostvector cppad::eigen_vector cppad_eigenvector' },
...
{ tag: 'speed_cppad_jit', title:'Speed Test Derivatives Using cppad_jit', other:' purpose running tests' },
{ tag: 'cppad_jit_det_minor.cpp', title:'cppad_jit Speed: Gradient of Determinant by Minor Expansion', other:' specifications implementation' },
{ tag: 'cppad_jit_det_lu.cpp', title:'cppad_jit Speed: Gradient of Determinant Using Lu Factorization', other:' specifications implementation' },
{ tag: 'cppad_jit_mat_mul.cpp', title:'cppad_jit Speed: Matrix Multiplication', other:' specifications implementation' },
{ tag: 'cppad_jit_ode.cpp', title:'cppad_jit Speed: Ode', other:' specifications implementation' },
{ tag: 'cppad_jit_poly.cpp', title:'cppad_jit Speed: Second Derivative of a Polynomial', other:' specifications implementation' },
{ tag: 'cppad_jit_sparse_hessian.cpp', title:'cppad_jit Speed: Sparse Hessian', other:' specifications' },
{ tag: 'cppad_jit_sparse_jacobian.cpp', title:'cppad_jit Speed: sparse_jacobian', other:' specifications' },
...
{ tag: 'whats_new_22', title:'Changes and Additions to CppAD During 2022', other:' 11-05 08-30 07-16 07-14 07-12 07-10 07-08 07-05 06-23 06-22 06-21 06-20 05-27 05-26 05-20 05-19 05-17 05-16 05-15 05-13 05-12 05-11 05-10 05-09 05-07 05-06 04-21 04-20 04-19 04-15 03-29 03-26 03-25 03-24 03-23 02-21 02-19 02-18 02-17 02-16 02-13 02-12 02-11 02-01 01-27 01-25 01-23 01-19 01-15 01-06 01-04 01-01' },
