...
{   bool ok = true;
    ...
    //
    // double_t
    llvm::Type* double_t = llvm::Type::getDoubleTy(*context_ir);
    //
    // double_ptr_t
    ...
    std::vector<llvm::Type*> param_types = { double_ptr_t, double_ptr_t };
    ...
    assert( function_ir->arg_begin() + 2  == function_ir->arg_end() );
    //
    // input_ptr
    ...
    assert( function_ir == module_ir->getFunction(function_name) );
    //
    // Validate the generated code, checking for consistency
    llvm::verifyFunction(*function_ir);
    //
    return ok;
}
// ----------------------------------------------------------------------------
