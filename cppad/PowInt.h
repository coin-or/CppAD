...
$head Deprecated$$
This entire function has been deprecated and is replaced
by they fact that the $cref/pow/$$ function now works properly
with negative values for $italic x$$ and integer values for $italic y$$.
...
$head Include$$
The file $code cppad/PowInt.h$$ is included by $code cppad/cppad.hpp$$
