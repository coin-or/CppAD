...
{	CPPAD_ASSERT_UNKNOWN( J >= p + 1 );
	...
	CPPAD_ASSERT_UNKNOWN( p == 0 || ! print );
...
# endif
	...
	const size_t user_k  = p;    // order of this forward mode calculation
	const size_t user_k1 = p+1;  // number of orders for this calculation
...
# endif
	while(op != EndOp)
	{
		...
		{
			case AbsOp:
			forward_abs_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------

			case AddvvOp:
			forward_addvv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------

			case AddpvOp:
			CPPAD_ASSERT_UNKNOWN( size_t(arg[0]) < num_par );
			forward_addpv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------
			...
			forward_acos_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------
			...
			// sqrt(1 - x * x), asin(x)
			CPPAD_ASSERT_UNKNOWN( i_var < numvar  );
			forward_asin_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------
			...
			// 1 + x * x, atan(x)
			CPPAD_ASSERT_UNKNOWN( i_var < numvar  );
			forward_atan_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------
			...
			forward_csum_op(
				p, i_var, arg, num_par, parameter, J, Taylor
			);
			break;
			// -------------------------------------------------
...
# endif
			...
			// sin(x), cos(x)
			CPPAD_ASSERT_UNKNOWN( i_var < numvar  );
			forward_cos_op(p, i_var, arg[0], J, Taylor);
			break;
			// ---------------------------------------------------
			...
			// sinh(x), cosh(x)
			CPPAD_ASSERT_UNKNOWN( i_var < numvar  );
			forward_cosh_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------
...
# endif
			{	Taylor[ i_var * J + p] = Base(0);
			}
			break;
			// -------------------------------------------------

			case DivvvOp:
			forward_divvv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------

			case DivpvOp:
			CPPAD_ASSERT_UNKNOWN( size_t(arg[0]) < num_par );
			forward_divpv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------

			case DivvpOp:
			CPPAD_ASSERT_UNKNOWN( size_t(arg[1]) < num_par );
			forward_divvp_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------
			...
			case ExpOp:
			forward_exp_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------
...
# endif
			{	forward_load_op( op, p, i_var, arg, J, Taylor);
			}
			break;
			// -------------------------------------------------
...
# endif
			...
			case LogOp:
			forward_log_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------

			case MulvvOp:
			forward_mulvv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------

			case MulpvOp:
			CPPAD_ASSERT_UNKNOWN( size_t(arg[0]) < num_par );
			forward_mulpv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------

			case ParOp:
# if ! CPPAD_USE_FORWARD0SWEEP
			if( p == 0 ) forward_par_op_0(
...
# endif
			...
			case PowvpOp:
			CPPAD_ASSERT_UNKNOWN( size_t(arg[1]) < num_par );
			forward_powvp_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------

			case PowpvOp:
			CPPAD_ASSERT_UNKNOWN( size_t(arg[0]) < num_par );
			forward_powpv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------

			case PowvvOp:
			forward_powvv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------
...
# endif
			...
			// cos(x), sin(x)
			CPPAD_ASSERT_UNKNOWN( i_var < numvar  );
			forward_sign_op(p, i_var, arg[0], J, Taylor);
			break;

			case SinOp:
			// cos(x), sin(x)
			CPPAD_ASSERT_UNKNOWN( i_var < numvar  );
			forward_sin_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------
			...
			// cosh(x), sinh(x)
			CPPAD_ASSERT_UNKNOWN( i_var < numvar  );
			forward_sinh_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------

			case SqrtOp:
			forward_sqrt_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------
...
# endif
			...
			case SubvvOp:
			forward_subvv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------

			case SubpvOp:
			CPPAD_ASSERT_UNKNOWN( size_t(arg[0]) < num_par );
			forward_subpv_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------

			case SubvpOp:
			CPPAD_ASSERT_UNKNOWN( size_t(arg[1]) < num_par );
			forward_subvp_op(p, i_var, arg, parameter, J, Taylor);
			break;
			// -------------------------------------------------
			...
			// tan(x)^2, tan(x)
			CPPAD_ASSERT_UNKNOWN( i_var < numvar  );
			forward_tan_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------
			...
			// tanh(x)^2, tanh(x)
			CPPAD_ASSERT_UNKNOWN( i_var < numvar  );
			forward_tanh_op(p, i_var, arg[0], J, Taylor);
			break;
			// -------------------------------------------------
