...
$codei%
	ad_ipopt\ad_ipopt_windows.bat %from_directory%
%$$

$lnext
In Visual Studio open the project file
$codep
	ad_ipopt\ad_ipopt.sln
$$
...
rem ---------------------------------------------------------------------------
rem
echo Dos script for linking ipopt to ad_ipopt examples
rem
if not exist "%1\VisualStudio-Coinall"  goto ERROR_MESSAGE
if not exist ad_ipopt                   goto ERROR_MESSAGE
rem
echo "creating ad_ipopt\include\coin directory"
mkdir ad_ipopt\include\coin
echo "creating ad_ipopt\lib directry"
mkdir ad_ipopt\lib
rem
echo "copying necessary ipopt include files to ad_ipopt\include\coin directory"
copy %1\VisualStudio-Coinall\include\coin\config_ipopt.h  ad_ipopt\include\coin
copy %1\VisualStudio-Coinall\include\coin\Ip*.hpp         ad_ipopt\include\coin
copy %1\VisualStudio-Coinall\include\coin\Ip*.h           ad_ipopt\include\coin
rem
echo "copying ipopt library to ad_ipopt\lib directory"
copy %1\VisualStudio-Coinall\lib\libipopt.lib ad_ipopt\lib
rem
echo "copying ifort libraries to ad_ipopt\lib directory"
copy %1\VisualStudio-Coinall\lib\ifort\* ad_ipopt\lib
rem
goto DONE
: ERROR_MESSAGE
echo usage: ad_ipopt\ad_ipopt_windows from_directory
