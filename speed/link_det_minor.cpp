...
For this test, the operation sequence is the same for each repetition 
and it is valid for an AD package to use one recording of the 
operation sequence to compute the derivatives for all repetitions.
