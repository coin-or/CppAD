...
$table
$bold Syntax$$
$cnext $syntax%# include "example_/DetOfMinor.h"%$$ 
$rnext
...
the file $code example_/DetOfMinor.h$$.
...
$verbatim%example_/DetOfMinor.h%0%// BEGIN PROGRAM%// END PROGRAM%1%$$
