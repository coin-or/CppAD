...
$table
$bold Syntax$$
$rnext $cnext $syntax%# include "example_/DetByLu.h"%$$
...
the file $code example_/DetByLu.h$$.
...
$verbatim%example_/DetByLu.h%0%// BEGIN PROGRAM%// END PROGRAM%1%$$
