...
$table
$bold Syntax$$
$rnext $cnext $syntax%# include "example_/DetByMinor.h"%$$
...
the file $code example_/DetByMinor.h$$.
...
$verbatim%example_/DetByMinor.h%0%// BEGIN PROGRAM%// END PROGRAM%1%$$
