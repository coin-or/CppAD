...
{   typedef std::pair<std::string, graph_op_enum> pair;
    ...
    op_info op_info_vec[] = {
        ...
        { atom_graph_op,     "atom",     0 }, // variable number result and arg
        ...
        { comp_eq_graph_op,  "comp_eq",  0 }, // variable number result and arg
        ...
        { sum_graph_op,      "sum",      0 }, // variable number result and arg
